...
class AddRelationsToOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        Schema::table('order_details', function (Blueprint $table) {
            //
            $table->$table->dropIndex('order_details_order_id_foreign');
        });
        Schema::table('order_details', function (Blueprint $table) {
            //
        ...
        Schema::table('order_details', function (Blueprint $table) {
            //
            $table->$table->dropIndex('order_details_product_id_foreign');
        });
        Schema::table('order_details', function (Blueprint $table) {
            //
